                ...
                <div class="card card-plain mt-8">
                  ...
                  <div class="card-body">
                    <form action="login_db.php" method="post">
                      <h5>อีเมล*</h5>
                      <div class="mb-3">
                        <input type="email" class="form-control" name="txt_email" placeholder="exam@gmail.com" require autocomplete="off">
                      </div>
                      <h5>รหัสผ่าน*</h5>
                      <div class="mb-3">
                        <input type="password" class="form-control" name="txt_password" placeholder="กรอกรหัสผ่าน" require>
                      </div>
                      <!-- สถานะ -->
                  ...
                  <div class="card-footer text-center pt-0 px-lg-2 px-1">
                    ...
                    <h6 class="nav-link  active text-danger" href="register.php">สร้างบัญชีใหม่</h6>
                    </p>
                  </div>
                </div>
              </div>
