          ...
          <tbody>
            ...
            foreach ($query as $data) : ?>
              <tr>
                ...
                <td> <a href="?&function=details&id=<?= $data['s_id'] ?>" class=" btn-sm btn-gray-600"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="icon " style="display: inline-block;color: #1e48dd;height: 2em;width: 2em;" viewBox="0 0 16 16">
