...
<div class="row justify-content-between">
  ...
  <div class="d-flex justify-content-end">
    <div class="d-flex justify-content-end mb-3">
        <a href="?function=SuccessContract" class="btn btn-sm1 btn-green text-white m-1">ครบสัญญา</a>
  ...
  <div class="row">
    <div class="card">
      <!-- title -->
      <h5 class="font-weight-bolder text-dark text-gradient m-3">รายงานสรุปการชำระดอกเบี้ย</h5>
              ...
              <thead>
                <div class="card-body overflow-auto p-1  " style="text-align: center">
                  <tr class="">
                    ...
                    <th scope="col">งวดที่ค้างชำระ</th>
