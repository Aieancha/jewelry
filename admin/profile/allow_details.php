    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <div class="container-fluid">
            ...
            <div class="card-body">
                ...
                <a href="?page=<?= $_GET['page'] ?>&function=updateStatusCus&id=<?=$result['c_id']?>"onclick="return confirm('คุณต้องการอนุญาติให้ : <?= $result['c_email'] ?> เข้าใช้งานระบบหรือไม่')"  class="btn btn-sm btn-green3 text-white">อนุมัติ</a>
