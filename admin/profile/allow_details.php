    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <div class="container-fluid">
            ...
            <div class="card-body">
                ...
                <a href="?page=<?= $_GET['page'] ?>&function=customr" class="btn btn-sm btn-green3 text-white">อนุมัติ</a>
                <a href="" onclick="return confirm('คุณต้องการลบผู้ขอเข้าใช้งานระบบ : <?= $data['c_name'] ?> หรือไม่')" class="btn btn-sm btn-danger">ลบคำขอ</a>
