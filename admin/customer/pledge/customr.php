          ...
          <div class="col-auto mb-3">
            ...
            if (isset($_POST) && !empty($_POST)) {
              ...
              $sql = "UPDATE tbl_social t1 JOIN tbl_orders t2 ON (t1.s_id = t2.s_id) SET t2.price_img='$price_img', t1.s_name='$s_name',t1.s_lastname='$s_lastname',
               ...
               t1.c_email='$email', t1.c_img='$filename', t2.r_mount='$mount', t2.rate_name='$rate_name',t2.o_price='$o_price',t2.o_total='$total',t2.o_inter='$inter'WHERE t2.o_id = '$id'";
            ...
            <div class="d-flex flex-row col-12">
              <div class="justify-content-start flex-fill col-6 ">
                ...
                <div class=" mb-3 col-4 ">
                  <h6 style="display: inline;">Facebook : </h6>
                  <input type="text" min="0" name="c_facebook" class="form-control " value="<?= $rs['c_facebook'] ?>" autocomplete="off">
                </div>
                <div class=" mb-3 col-4 ">
                  <h6 style="display: inline;">LINE: </h6>
                  <input type="text" min="0" name="c_line" class="form-control " value="<?= $rs['c_line'] ?>" autocomplete="off">
                </div>
                <div class=" mb-3 col-6 ">
