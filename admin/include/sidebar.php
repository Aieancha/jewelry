...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl  fixed-start  bg-dark" style="overflow: hidden" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto h-auto mb-9" style="overflow: hidden" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
  ...
  <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146zM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5z"/>
        ...
        <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['page']) && ($_GET['page']) == 'pledge' ? 'active': '' ?> " href="?page=pledge">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<title>credit-card</title>
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6 text-white">สำหรับผู้ดูเเลระบบ</h6>
        </li>
        <li class="nav-item">
  ...
  <title>customer-support</title>
        ...
        <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['page']) && ($_GET['page']) == 'allow' ? 'active': '' ?> " href="?page=allow">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M11 15a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm5-4a5 5 0 1 1-10 0 5 5 0 0 1 10 0z"/>
  <path d="M9.438 11.944c.047.596.518 1.06 1.363 1.116v.44h.375v-.443c.875-.061 1.386-.529 1.386-1.207 0-.618-.39-.936-1.09-1.1l-.296-.07v-1.2c.376.043.614.248.671.532h.658c-.047-.575-.54-1.024-1.329-1.073V8.5h-.375v.45c-.747.073-1.255.522-1.255 1.158 0 .562.378.92 1.007 1.066l.248.061v1.272c-.384-.058-.639-.27-.696-.563h-.668zm1.36-1.354c-.369-.085-.569-.26-.569-.522 0-.294.216-.514.572-.578v1.1h-.003zm.432.746c.449.104.655.272.655.569 0 .339-.257.571-.709.614v-1.195l.054.012z"/>
...
<title>credit-card</title>
            ...
            <span class="nav-link-text ms-1">จัดการผู้ขอใช้งานระบบ</span>
          </a>
        </li>
        ...
        <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['page']) && ($_GET['page']) == 'sign-out' ? 'active': '' ?> " href="?page=sign-out">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer mx-3 ">
      ...
      <a class="btn btn-blue2 text-white mt-3 w-100" href="?page=logout">ออกจากระบบ</a>
    </div>
